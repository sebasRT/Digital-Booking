...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, jakarta.servlet.FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        String[] user = {userDetails.getUsername(), userDetails.getNombre(), userDetails.getApellido(), userDetails.getId().toString(), userDetails.getCiudad(),userDetails.getPassword(),userDetails.getRolId().toString(),userDetails.getRolNombre().toString(),token};
